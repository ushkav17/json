(function() {
    // Wrap initialization so that the DOM is ready
    function runWidget() {
        // Load marked library (for markdown-to-HTML conversion)
        const markedScript = document.createElement('script');
        markedScript.src = 'https://cdn.jsdelivr.net/npm/marked/marked.min.js';
        markedScript.async = true;
        document.head.appendChild(markedScript);

        // Helper to convert markdown to HTML if marked is available
        ...
        // Helper to generate a UUID for session IDs
        ...
        async function startNewConversation() {
            ...
            // Force the chat container to open (for debug/testing)
            ...
            try {
                ...
                // Hide the new conversation view and show the chat interface
                ...
                // For testing, bypass markdown conversion:
                botMessageDiv.innerHTML = convertMarkdown(messageContent);
