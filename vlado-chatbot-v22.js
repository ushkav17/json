...
(function () {
  ...
  const styles = `
    ...
    :host .chat-messages {
      ...
      display: flex;
      flex-direction: column;
      scroll-behavior: smooth; /* helps with scrollIntoView */
    }
    :host .chat-message {
      padding: 12px 16px;
      margin: 8px 0;
  ...
  // ✅ Scroll so we see the START of a message bubble, not the end
  ...
  async function startNewConversation() {
    ...
    try {
      ...
      if (data.data && Array.isArray(data.data)) {
        ...
        // show the start of the last message in history (usually what user expects)
  ...
  // ✅ sendMessage shows wave typing indicator and scrolls to START of the bubble
  async function sendMessage(message) {
    ...
    try {
      ...
      // ✅ this is the key change: show the START of the reply bubble
      scrollToMessageTop(botMsg);
    } catch (err) {
      typingMsg.remove();
