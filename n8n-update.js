(function() {
    ...
    function runWidget() {
        // Load marked library for markdown-to-HTML conversion (if you prefer markdown responses)
        const markedScript = document.createElement('script');
        markedScript.src = 'https://cdn.jsdelivr.net/npm/marked/marked.min.js';
        markedScript.async = true;
        document.head.appendChild(markedScript);

        // Helper function: converts markdown to HTML if marked is available, otherwise returns plain text.
        function convertMarkdown(mdText) {
            if (typeof marked !== 'undefined') {
                return marked(mdText);
            } else {
                // Optionally log if marked is not ready yet.
        ...
        async function startNewConversation() {
            ...
            try {
                ...
                console.log('Started new conversation:', responseData);
                // Hide the header and new conversation view and show chat interface
    ...
    // Ensure the DOM is ready before running the widget
